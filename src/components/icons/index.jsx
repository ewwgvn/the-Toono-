...
// IcHeart: Shagai (шагай) — Mongolian ankle bone like icon
export const IcHeart = ({filled}) => <svg
  width="22" height="19" viewBox="0 0 82.08 70.55" fill="none"
  className={filled ? "shagai-liked" : ""}
  style={filled ? { color: "#E24B4A" } : {}}
>
  <path d="M65.09,24.15c.43,1.12-.87,1.71-1.71,1.8-7.09.75-13.96-.07-19.52-4.67-6.34-5.25-10.51-2.2-11.37-4.33s6.45-3.13,12.4,1.12c2.22,1.59,4.3,3.15,6.92,4.02,3.6,1.2,7.24,1.52,11.08,1.38.6-.02,2,.15,2.2.67Z"
    fill={filled ? "#E24B4A" : "currentColor"} stroke={filled ? "#E24B4A" : "currentColor"} strokeWidth="1.5"/>
