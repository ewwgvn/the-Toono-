              ...
              <div style={{ flex: 1, padding: "12px 14px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  {!item.digital && <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <button type="button" aria-label="Тоо багасгах" onClick={() => setQty(q => ({ ...q, [itemKey(item)]: Math.max(1, getQty(item) - 1) }))} style={{ width: 44, height: 44, borderRadius: 10, background: T.s2, border: `1px solid ${T.border}`, color: T.textH, cursor: "pointer", fontFamily: "'Helvetica Neue', Arial, sans-serif", fontSize: 16, display: "flex", alignItems: "center", justifyContent: "center" }}>−</button>
