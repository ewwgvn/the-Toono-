    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", background: T.bg }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", scrollbarWidth: "none" }}>
        <div style={{ padding: "24px 20px 0", display: "flex", flexDirection: "column", alignItems: "center" }}>
          <div style={{ width: 132, height: 132, borderRadius: "50%", overflow: "hidden", background: T.s2 }}>
            {GS.user.photo
              ? <img src={GS.user.photo} alt={GS.user.name} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              : <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}><Toono size={50} color={T.textDim} /></div>}
          </div>
          <div style={{ fontFamily: HELV, fontSize: 26, fontWeight: 800, color: T.textH, letterSpacing: "-0.02em", lineHeight: 1.1, marginTop: 16, textAlign: "center", wordBreak: "break-word" }}>{GS.user.name || "Uliger"}</div>
          <div style={{ fontFamily: HELV, fontSize: 11, fontWeight: 600, letterSpacing: "0.22em", textTransform: "uppercase", color: T.textDim, marginTop: 8 }}>{GS.user.field || "ULIGER USER"}</div>
