...
export default function Splash() {
  ...
  return <div style={{height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:T.bg,position:"relative",overflow:"hidden"}}>
    <StoryDecor variant="moon" size={88} style={{position:"absolute",top:28,right:18,opacity:.9}}/>
    <StoryDecor variant="stars" size={72} style={{position:"absolute",bottom:64,left:10,opacity:.85}}/>
