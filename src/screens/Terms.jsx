...
export default function Terms({ nav, goBack }) {
  return <Simple nav={nav} title="Үйлчилгээний нөхцөл" back="settings">
    <div style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", fontSize: 14, color: T.textB, lineHeight: 1.8, padding: "0 4px" }}>
      <h3 style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", fontSize: 18, fontWeight: 700, color: T.textH, marginBottom: 16 }}>Үлгэр — Үйлчилгээний нөхцөл</h3>
      ...
      <p style={{ marginBottom: 16 }}>Үлгэр нь Монголын бүтээлчдийг дэмжих дижитал зах зээлийн платформ юм. Энэхүү нөхцөлийг зөвшөөрснөөр та манай үйлчилгээг ашиглах эрхтэй болно.</p>
      ...
      <p style={{ marginBottom: 16 }}>Бүх төлбөрийг Үлгэр-ийн escrow систем хамгаална. Худалдан авагч бүтээлээ хүлээн авсны дараа мөнгө бүтээлчид шилжинэ.</p>
